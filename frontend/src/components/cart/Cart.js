...
//                                                 <p id="card_item_price">Rs.{item.price * 75}</p>
//                                             </div>
...
//                                 <p>Est. total: <span className="order-summary-values">Rs{cartItems.reduce((acc, item) => acc + item.quantity * item.price*75, 0).toFixed(2)}</span></p>
